...
const authFile = path.join(__dirname, '../users/baseUser.json');
...
test('authorization', async () => {
  ...
  // await page.getByRole('button', { name: 'Ок' }).click(); //cookie area
  ...
  await page
    ...
    .click();
  await page.getByRole('img', { name: 'Иконка канала channel59275146' }).click();
